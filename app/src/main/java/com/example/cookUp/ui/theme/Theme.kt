...
private val LightColorPalette = CookUpColors(
    brand = Shadow5,
...
private val DarkColorPalette = CookUpColors(
    brand = Shadow1,
...
object CookUpTheme {
    val colors: CookUpColors
        @Composable
        get() = LocalCookUpColors.current
}

/**
 * CookUp custom Color Palette
 */
@Stable
class CookUpColors(
    ...
    fun copy(): CookUpColors = CookUpColors(
...
fun ProvideCookUpColors(
    ...
    CompositionLocalProvider(LocalCookUpColors provides colorPalette, content = content)
}

private val LocalCookUpColors = staticCompositionLocalOf<CookUpColors> {
    error("No CookUpColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [CookUpTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
