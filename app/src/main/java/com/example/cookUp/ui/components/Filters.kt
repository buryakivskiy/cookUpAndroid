...
fun FilterChip(
    ...
    val backgroundColor by animateColorAsState(
        if (selected) CookUpTheme.colors.brandSecondary else CookUpTheme.colors.uiBackground,
    ...
    val textColor by animateColorAsState(
        if (selected) Color.Black else CookUpTheme.colors.textSecondary,
        label = "text color"
    )
        ...
        val backgroundPressed =
            if (pressed) {
                Modifier.offsetGradientBackground(
                    CookUpTheme.colors.interactiveSecondary,
                    200f,
                    0f
                )
            } else {
