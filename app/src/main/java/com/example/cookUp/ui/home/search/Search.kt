...
import com.example.cookUp.model.SearchCategoryCollection
import com.example.cookUp.model.SearchRepo
import com.example.cookUp.model.SearchSuggestionGroup
...
import com.example.cookUp.ui.utils.mirroringBackIcon
...
fun Search(
    ...
    CookUpScaffold(
        ...
        CookUpSurface(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
            Column {
...
private fun rememberSearchState(
    ...
    filters: List<Filter> = RecipeRepo.getFilters(),
...
private fun SearchBar(
    ...
    CookUpSurface(
        color = CookUpTheme.colors.uiFloated,
            ...
            Row(
                ...
                if (searchFocused) {
                    IconButton(onClick = onClearQuery) {
                        Icon(
                            ...
                            tint = CookUpTheme.colors.iconPrimary,
                ...
                if (searching) {
                    CircularProgressIndicator(
                        color = CookUpTheme.colors.iconPrimary,
                        modifier = Modifier
...
private fun SearchHint() {
    Row(
        ...
        Icon(
            ...
            tint = CookUpTheme.colors.textHelp,
            contentDescription = stringResource(R.string.label_search)
        )
        Spacer(Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.search_CookUp),
